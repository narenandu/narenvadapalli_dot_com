...
import vueLogo from "../../static/images/skills/react.png";
import reactLogo from "../../static/images/skills/vue.png";
...
export default function() {
    return (
        <div>
            <p className="titles">
                I am a Software Developer who believes in SOLID principles and
            ...
            <section id="WorkExperiencePage">
                ...
                <VerticalTimeline>
                    ...
                    <VerticalTimelineElement
                        ...
                        icon={
                            <img
                                alt="Bardel Entertainment Inc"
                                title="Bardel Entertainment Inc"
                                class="logo-size"
                                src={bardelLogo}
                            ></img>
                        }
                    >
                        ...
                        <h7 className="vertical-timeline-element-subtitle">
                            Bardel Entertainment Inc, Vancouver, Canada
                        </h7>
                        <p>
                            Member of the core Pipeline Team, contributing to
                            the Design and Development of next generation
                            Software Components in the pipeline, such as custom
                            schema based version control system for data/assets
                            in the Pipeline. Adding Tests, Refactoring the
                            legacy code to bring it to certain level of
                            stability with a CI/CD built around the legacy code
                            using JenkinsCI, Docker, helm and RedHat Openshift
                            Web apps written in python flask and socketio,
                            example an interface between ShotGun and Production
                            Pipeline (Render farm submitter with status updates
                            on submission)
                        </p>
                    </VerticalTimelineElement>
                    <VerticalTimelineElement
                        ...
                        icon={
                            <img
                                alt="On Animation Studios"
                                title="On Animation Studios"
                                class="logo-size"
                                src={onAnimationLogo}
                            ></img>
                        }
                    >
                        <h6 className="vertical-timeline-element-title">
                            Chief Pipeline Technical Director
                        </h6>
                        <h7 className="vertical-timeline-element-subtitle">
                    ...
                    <VerticalTimelineElement
                        ...
                        icon={
                            <img
                                alt="DreamWorks Animations"
                                title="DreamWorks Animations"
                                class="logo-size"
                                src={dreamWorksLogo}
                            ></img>
                        }
                    >
                        ...
                        <h7 className="vertical-timeline-element-subtitle">
                            DreamWorks Animations, Bengaluru, India
                        </h7>
                        <p>
                            Worked for FX in the CG Animation features "Penguins
                            of Madagascar", "Kung Fu Panda 3", "Boss Baby". Day
                            to day duties involve the development of Pipeline
                            tools for FX artists. Debugging issues related to
                            Pipeline flow as well as HOUDINI. Knowing the
                            dependencies with immediate departments Lighting and
                            Animation/Character Effects/Crowds. Worked for
                            Animation in CG Animation features like Mr.Peabody
                            and Sherman as an Animation Technical Director.
                            Typical duties involves Animation pipeline
                            maintenance, upgrading/creating new features in the
                            pipeline, Writing scripts, Helping out artists in
                            debugging on the production issues. Past projects
                            include DreamWorks Dragons Riders of Berk, the TV
                            series for Cartoon Network (Episodes: 2,4,10 and 12)
                        </p>
                    </VerticalTimelineElement>
                    <VerticalTimelineElement
                        className="vertical-timeline-element--work"
                    ...
                    >
                        <h6 className="vertical-timeline-element-title">
                            CG Software Engineer - Intern
                        </h6>
                        <h7 className="vertical-timeline-element-subtitle">
                            EA Sports Tiburon, Orlando, FL, USA
                        </h7>
                        <p>
                            Graphics Solutions, Internal Tools and Pipelines for
                            Core Football Graphics Team. This was a 3 months
                            internship where I got a taste of how the game
                            development happens but it was too short a time to
                            do any valuable contribution except for a couple of
                            small bug fixes that went in to Madden/NCAA 2012
                        </p>
                    </VerticalTimelineElement>
                    <VerticalTimelineElement
                        className="vertical-timeline-element--work"
                    ...
                    >
                        ...
                        <h7 className="vertical-timeline-element-subtitle">
                            Samsung India Software Operations, Bengaluru, India
                        </h7>
                        <p>
                            Worked in Embedded software team which develops CDMA
                            mobile applications for USA Tier-2 CDMA carriers.
                            Responsible for the development and maintainance of
                            MP3 Player application front end. Performed several
                            IOTs in messaging and browser modules.
                        </p>
                    </VerticalTimelineElement>
                    <VerticalTimelineElement
                        className="vertical-timeline-element--work"
                    ...
                    >
                        ...
                        <h7 className="vertical-timeline-element-subtitle">
                            Motorola India Pvt Ltd, Bengaluru, India
                        </h7>
                        <p>
                            Responsible for the performance and bug fixing of
                            the BREW PEK module. Validation and fixing of all
                            the BREW APIs as per the carrier specific
                            requirements and device data sheet submitted to
                            Qualcomm (CDMA mobile phones).
                        </p>
                    </VerticalTimelineElement>
                </VerticalTimeline>
            </section>
            <section id="EducationPage">
                ...
                <VerticalTimeline>
                    ...
                    >
                        ...
                        <p>
                            State-of-the-art graphics and animation
                            technologies, as well as interactive media design
                            principles, product development methodologies and
                            engineering entrepreneurship The CGGT program
                            prepares students for positions requiring
                            multidisciplinary skills such as designers,
                            technical animators, technical directors and game
                            programmers
                        </p>
                    </VerticalTimelineElement>
                    <VerticalTimelineElement
                    ...
                    >
                        <h6 className="vertical-timeline-element-title">
                            Electronics and Communcation Engineering (BTech)
                        </h6>
                        <h7 className="vertical-timeline-element-subtitle">
                            National Institute of Technology, Warangal, India
                        </h7>
                        <p>
                            The ECE Department at NITW has been an international
                            reputation of excellence in teaching, research and
                            service. With excellent laboratory facilities and
                            dedicated faculty, the department of ECE offers
                            broad range of programs includes VLSI design.
                        </p>
                    </VerticalTimelineElement>
                </VerticalTimeline>
            </section>
            <section id="SkillsPage">
                ...
                <VerticalTimeline>
                    ...
                    <VerticalTimelineElement
                        ...
                        icon={
                            <img alt="" class="logo-size" src={cloudLogo}></img>
                        }
                    >
                        <h6 className="vertical-timeline-element-title">
                            Cloud Platforms
                    ...
                    <VerticalTimelineElement
                        ...
                        icon={
                            <img alt="" class="logo-size" src={dccLogo}></img>
                        }
                    >
                        <h6 className="vertical-timeline-element-title">
